            ...
            <div className="flex space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={handleAddToCart} className="bg-slate-900 text-white px-4 py-2 rounded-xl text-sm font-medium flex items-center space-x-1 hover:bg-slate-800 transition-colors">
