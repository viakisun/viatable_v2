      ...
      <div className="p-4 space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 mb-2">
            {itemData.name[selectedLanguage]}
          </h1>
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            {itemData.description[selectedLanguage]}
          </p>

          <div className="flex items-center justify-between">
            <div className="text-2xl font-bold text-slate-900">
              {currencySymbol}{itemData.price[currencyCode].toLocaleString()}{selectedLanguage === 'ko' ? '원' : ''}
            </div>
        ...
        <div className="bg-white rounded-xl p-4">
          ...
          <div className="space-y-4">
            {Object.entries(customizationOptions[selectedLanguage]).map(([category, data]) => (
              <div key={category}>
            ...
            <div className="mt-4 space-y-3">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {itemData.ingredients[selectedLanguage].map((ingredient, index) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {itemData.allergens[selectedLanguage].map((allergen, index) => (
